...
const EN = {
  ...
  'settings.mute': 'Mute',
  'settings.highlightMyGun': 'Highlight my gun (orange)',
...
const KO: Record<StringKey, string> = {
  ...
  'settings.mute': '음소거',
  'settings.highlightMyGun': '내 총 주황색 표시',
...
const ZH: Record<StringKey, string> = {
  ...
  'settings.mute': '静音',
  'settings.highlightMyGun': '高亮我的武器（橙色）',
...
const ES: Record<StringKey, string> = {
  ...
  'settings.highlightMyGun': 'Resaltar mi arma (naranja)',
...
const PT: Record<StringKey, string> = {
  ...
  'settings.mute': 'Silenciar',
  'settings.highlightMyGun': 'Destacar minha arma (laranja)',
  'settings.language': 'Idioma',
  'credits.heading': 'Créditos',
