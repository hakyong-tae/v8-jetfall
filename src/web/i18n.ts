...
const EN = {
  ...
  'room.killLimit': 'Kill Limit',
  'room.capLimit': 'Capture Limit',
...
const ES: Record<StringKey, string> = {
  ...
  'room.weapons': 'Armas',
  'room.killLimit': 'Límite de bajas',
  'room.capLimit': 'Límite de capturas',
...
const PT: Record<StringKey, string> = {
  ...
  'room.weapons': 'Armas',
  'room.killLimit': 'Limite de abates',
  'room.capLimit': 'Limite de capturas',
